...
$idm = $_POST["idn"];
$nombren = $_POST["nomn"];
$direccionn = $_POST["dirn"];
$telefonon = $_POST["teln"];
$correon = $_POST["emailn"];
// Se insertan los datos recibidos de la pagina del formulario con la funcion 'mysql_query'
//mysql_query("UPDATE cliente SET  nombre ='$nombren'  WHERE id_cliente ='$idm'");
mysql_query("UPDATE cliente SET   direccion='$direccionn'  WHERE id_cliente ='$idm'");
mysql_query("UPDATE cliente SET   telefono='$telefonon'  WHERE id_cliente ='$idm'");
mysql_query("UPDATE cliente SET  email='$correon' WHERE id_cliente ='$idm'");
...
echo "Registro con el id = '$idm'  modificado"; 

?>
<br/>
<form action="modificar.php" method="post">
<legend>Modificar</legend>
<input type="number" placeholder="id" name="idn" required="required">
